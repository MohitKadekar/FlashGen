...
const FlashcardDetail = ({ flashcard, onEdit, onDelete }) => {
    return (
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="px-5 py-2 bg-red-900/20 hover:bg-red-900/40 text-red-500 hover:text-red-400 rounded-lg font-medium border border-red-900/50 hover:border-red-800 transition-all shadow-sm"
                    >
                        Delete
                    </button>
                </div>
